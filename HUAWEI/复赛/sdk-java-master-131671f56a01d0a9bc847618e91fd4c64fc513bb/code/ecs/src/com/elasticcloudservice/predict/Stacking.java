...
public class Stacking {
    ...
    public double[][] getStackingTrainData_ES(double[][] train_data_1,double[][] train_data_2,double model_1_a1,double model_1_a2,double model_2_a1,double model_2_a2) {
        ...
        double[] results_1 = eSmooth.Second_ES_With_a1_and_a2(model_1_train, model_1_a1, model_1_a2,1.0);
        double[] results_2 = eSmooth.Second_ES_With_a1_and_a2(model_2_train, model_2_a1, model_2_a2,1.0);
    ...
    public double getBestStepSize(double[] result_1,double[] result_2){//获取学习率
        int max_predict=0;
        double stepSize=0.001;
        for(int i=0;i<result_1.length;i++){
            if(max_predict<result_1[i]){
                max_predict=(int)result_1[i];
            }
            if(max_predict<result_2[i]){
                max_predict=(int)result_2[i];
            }
        }
        while(max_predict>0){
            stepSize*=0.1;
